...
//     // Map buckets to normalized objects
...
//     const max = useMemo(
//         () => Math.max(1, ...mapped.map(x => x.value)),
//         [mapped]
//     );
...
//                         return (
//                             <ListGroupItem key={`${name}-${idx}`} className="d-flex align-items-center justify-content-between">
//                                 <span>{name}</span>
