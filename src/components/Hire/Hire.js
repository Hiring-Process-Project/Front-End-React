...
//                         return s === "approved" || s === "accepted" || s === "hired";
//                     })
//                     .map((c) => ({
//                         id: c.id,
...
//     // 1. Ελέγχουμε αν έχει γίνει hire σε αυτό το jobAdId
//     useEffect(() => {
//         if (!jobAdId) return;

//         // Βρες αν κάποιος έχει ήδη προσληφθεί για το συγκεκριμένο jobAdId
//         const hiredCandidate = candidates.find(candidate => candidate.status === "Hired");

//         // Αν υπάρχει κάποιος hired, απενεργοποιούμε το κουμπί hire για όλους
//         setIsHireDisabled(!!hiredCandidate);
//     }, [candidates, jobAdId]);

//     // 2. Προσθήκη της κατάστασης για την απενεργοποίηση του κουμπιού HIRE
...
//             // Update UI: κρατάμε τον candidate στη λίστα και αλλάζουμε το status του σε "Hired"
//             setCandidates(prev =>
//                 prev.map(c => c.id === selectedCandidate.id ? { ...c, status: "Hired" } : c)
//             );
//             setSelectedCandidate(prev =>
//                 prev && prev.id === selectedCandidate.id ? { ...prev, status: "Hired" } : prev
//             );

//             //            await markJobAdComplete();
...
//                         <CardBody>
//                             {!selectedCandidate ? (
//                                 // Χωρίς εσωτερικό input — απλό κείμενο μέσα στο εξωτερικό πλαίσιο
//                                 <div style={{ opacity: 0.6 }}>
//                                     Select a candidate to see comments…
//                                 </div>
//                             ) : (
//                                 // Όταν υπάρχει candidate, δείξε τα σχόλια read-only
//                                 <Input
//                                     type="textarea"
//                                     rows={2}
//                                     value={candComment}
...
//                         disabled={isHireDisabled || !selectedCandidate}  // Εδώ προσθέτουμε τη συνθήκη για το κουμπί
